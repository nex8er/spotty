...
Q_SIGNALS:
    ...
    /**
     * \brief Изменилась настройка, а не данные.
     *
     * Отдельно от changed(), который приходит на каждый отсчёт — тысячами в секунду.
     * Сохранять настройки по нему значило бы писать файл на каждую строку устройства.
     */
