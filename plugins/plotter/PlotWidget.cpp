    ...
    , m_view(view)
{
    ...
    QToolButton *separator = makeButton(mdi::Table, tr("Field separator"));
    ...
    QToolButton *shot = makeButton(mdi::Camera,
...
void PlotWidget::updatePlayPause()
{
    ...
    m_playPause->setToolTip(paused ? tr("Resume collecting points for the plot")
                                   : tr("Pause collecting points for the plot"));
}
