...
public:
     ...
     *
     * При неудаче пишет предупреждение в журнал. Вызывающая сторона вправе продолжить
     * работу с урезанной функциональностью, а не завершаться: невозможность создать
     * каталог логов не повод не показывать данные с порта.
     */
